		...
		<?php if (GetUserBalance($userid, 1) >= MIN_PAYOUT) { ?>
			...
			<?php if (isset($_SESSION['password_verified']) && $_SESSION['password_verified'] > time()) { ?>
				...
				<tr>
					...
					<td align="left" valign="middle">
						<?php echo SITE_CURRENCY; ?><input type="text" class="textbox" name="amount" value="<?php echo @$amount; ?>" size="7" />
					</td>
				</tr>
				<tr>
			...
			<?php }else{ ?>
					...
					<tr height="50">
						...
						<td width="30%" align="left" valign="middle"><input type="password" class="textbox" name="password" value="" size="40" required="required" /></td>
