	...
	<h1><?php echo CBE1_COUPONS_TITLE; ?></h1>
		...
		<div id="tabs_container">
			<ul id="tabs">
				...
				<?php if ($exclusive_coupons_total > 0) { ?><li><a href="#exclusive"><span><?php echo CBE1_COUPONS_EXCLUSIVE; ?></span></a></li><?php } ?>
				<li><a href="#latest"><span><?php echo CBE1_COUPONS_LATEST; ?></span></a></li>
				<?php if ($expiring_coupons_total > 0) { ?><li><a href="#expiring"><span><?php echo CBE1_COUPONS_EXPIRING; ?></span></a></li><?php } ?>
			</ul>
		</div>
			...
			<table align="center" width="100%" border="0" cellspacing="0" cellpadding="5">
				...
				<tr>
					...
					<td width="80%" class="td_coupon" align="left" valign="top">
						<span class="coupon_name"><?php echo $row['title']; ?> <a href="<?php echo SITE_URL; ?>go2store.php?id=<?php echo $row['retailer_id']; ?>&c=<?php echo $row['coupon_id']; ?>" target="_blank"><?php echo $row['coupon_title']; ?></a></span>
					...
					<td class="td_coupon" align="left" valign="bottom">
						<?php if ($row['code'] != "") { ?><span class="coupon_code"><?php echo (HIDE_COUPONS == 0 || isLoggedIn()) ? $row['code'] : CBE1_COUPONS_CODE_HIDDEN; ?></span><?php } ?>
		...
		<?php
			...
			?>
				<table align="center" width="100%" border="0" cellspacing="0" cellpadding="5">
				<?php while ($top_row = mysql_fetch_array($top_result)) { $cc++; ?>
				<tr>
					<td class="td_coupon" width="<?php echo IMAGE_WIDTH; ?>" align="center" valign="top">
		...
		<?php
			...
			?>
				<table align="center" width="100%" border="0" cellspacing="0" cellpadding="5">
				<?php while ($last_row = mysql_fetch_array($last_result)) { $cc++; ?>
				<tr>
					<td class="td_coupon" width="<?php echo IMAGE_WIDTH; ?>" align="center" valign="top">
		...
		<?php
			...
			?>
				<table align="center" width="100%" border="0" cellspacing="0" cellpadding="5">
				<?php while ($exp_row = mysql_fetch_array($exp_result)) { $cc++; ?>
				<tr>
					<td class="td_coupon" width="<?php echo IMAGE_WIDTH; ?>" align="center" valign="top">
